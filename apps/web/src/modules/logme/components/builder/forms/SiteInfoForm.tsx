  ...
  return (
    <div className="space-y-6 w-full max-w-2xl mx-auto">
      <div>
        ...
        />
        {isAuthorTooLong && (
          <p className="text-sm text-red-500 mt-1">Please enter 10 characters or fewer.</p>
        )}
      </div>
      <div>
        ...
        />
        {isTitleTooLong && (
          <p className="text-sm text-red-500 mt-1">Please enter 40 characters or fewer.</p>
        )}
      </div>
      ...
      <div>
        <Label htmlFor="site-sub">
          Subdomain <span className="text-red-500">*</span> (lowercase letters, numbers, hyphens
          allowed)
        </Label>
        <Input
          id="site-sub"
